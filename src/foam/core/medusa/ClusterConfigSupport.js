...
configuration for contacting the primary node.`,
  ...
  javaImports: [
    ...
    'foam.core.medusa.ElectoralService',
    'foam.core.medusa.ElectoralServiceState',
    'foam.core.pm.PM',
  ...
  methods: [
    {
      ...
      type: 'foam.core.medusa.ClusterConfig',
      javaCode: `
...
//        .orderBy(ClusterConfig.IS_PRIMARY)
    ...
    },
   {
    ...
    },
    {
      ...
      type: 'foam.dao.DAO',
      javaCode: `
      return new foam.core.medusa.MedusaAdapterDAO.Builder(x)
    ...
    },
    {
      ...
      try {
        ...
        CSpecLookup lookup = (CSpecLookup) ((DAO) x.get("nspecLookupDAO")).find(serviceName);
        if ( lookup != null ) {
          getLogger().info("getMdao,CSpecLookup", serviceName, lookup.getReplacement());
          serviceName = lookup.getReplacement();
          dao = (DAO) x.get(serviceName);
          if ( dao == null ) {
            getLogger().warning("getMdao,CSpecLookup,CSpec not found", lookup.getId(), lookup.getReplacement());
          }
        }
        if ( dao == null ) {
          dao = (DAO) x.get(serviceName);
