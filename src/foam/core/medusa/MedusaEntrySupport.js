      ...
      javaCode: `
        ...
        for ( PropertyInfo p : props ) {
          ...
          try {
            ...
            // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay remote", old.getClass().getSimpleName(), "isSet/get", p.getName(), "from", old.getClass().getSimpleName(), e.getMessage());
            ...
            if ( p2 != null ) {
              ...
              try {
                ...
                foam.core.logger.StdoutLogger.instance().error("FObject.overlay remote", nu.getClass().getSimpleName(), "isSet/get", p.getName(), "from", old.getClass().getSimpleName(), ee.getMessage(), ee);
              }
            }
          }
          Object local = null;
          if ( p.isSet(old) ) {
            try {
              ...
              // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay local", nu.getClass().getSimpleName(), "get", p.getName(), "from", nu.getClass().getSimpleName(), e.getMessage());
            }
            if ( remote instanceof FObject &&
              ...
              try {
                ...
                // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay local", nu.getClass().getSimpleName(), "set", p.getName(), "overlay", remote.getClass().getSimpleName(), e.getMessage());
                p.set(nu, remote);
              }
            } else {
              p.set(nu, remote);
