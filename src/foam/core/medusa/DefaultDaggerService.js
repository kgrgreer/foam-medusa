...
foam.CLASS({
  ...
  properties: [
    {
      ...
      of: 'foam.core.medusa.DaggerBootstrap',
    ...
    },
    {
      name: 'links',
      class: 'Array',
      javaFactory: 'return new foam.core.medusa.DaggerLink[getBootstrap().getBootstrapHashEntries()];',
      visibility: 'HIDDEN'
    },
    {
      name: 'initialized',
  ...
  methods: [
    ...
    },
    {
      ...
      name: 'reconfigure',
      synchronized: true,
      args: 'X x, foam.core.medusa.DaggerBootstrap bootstrap',
    ...
    - Explicitly set in DaggerService CSpec
    - // TODO: HSM`,
